    ...
    public CrossAd(final Context context) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    String csv = run("https://docs.google.com/spreadsheets/d/e/2PACX-1vQsv4jjh3OMF4T4mrL9HoYbRjyJKGdxgn2L4O4ypllOpVn7OmV9XZIt8WYEinwuWy-UOeV9dPHm69YS/pub?output=csv");
                    Log.e("hehe", csv);
